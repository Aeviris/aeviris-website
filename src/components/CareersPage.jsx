...
export default function CareersPage() {
  const selectedFromUrl = new URLSearchParams(window.location.hash.split('?')[1] || window.location.search).get('role') || ''
