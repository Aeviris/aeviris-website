...
function App() {
  ...
  return <div id="top" className="app-shell">
    ...
    <main>
      ...
      <section className="final-cta"><div className="mesh" /><Reveal><p className="eyebrow">The next chapter is yours too</p><h2>Let’s build AI<br /><em>that matters.</em></h2><a href="/work-with-us" className="pill-button">Work with us <Icon name="arrow" size={17} /></a></Reveal></section>
    </main>
